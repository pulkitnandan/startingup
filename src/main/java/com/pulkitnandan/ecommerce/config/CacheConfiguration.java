package com.pulkitnandan.ecommerce.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("vesuvious");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("vesuvious");
        ...
        config.getMapConfigs().put("com.pulkitnandan.ecommerce.domain.*", initializeDomainMapConfig(jHipsterProperties));
